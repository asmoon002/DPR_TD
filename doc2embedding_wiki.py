...
if __name__ == "__main__":
    ...
    #수정
    parser.add_argument("--wikipedia_path",default="파일경로/WikiQA_Docs_split.tsv")
    ...
    progress_bar = tqdm(total=args.num_docs, disable=not distributed_state.is_main_process,ncols=100,desc='loading wikipedia...', leave=True)
