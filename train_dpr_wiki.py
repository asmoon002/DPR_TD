...
def parse_args():
    ...
    parser.add_argument("--config_file",default='config/train_dpr_wiki.yaml')
...
class QADataset(torch.utils.data.Dataset):
    ...
    def collate_fn(samples,tokenizer,args,stage):
        ...
        if stage == 'train':
            ...
            negative_passages = [x['negative_ctxs'][:min(args.num_other_negative_ctx,len(x['negative_ctxs']))] 
                                for x in samples]
